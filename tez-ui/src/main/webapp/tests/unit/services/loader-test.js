...
module('Unit | Service | loader', function(hooks) {
  ...
  test.skip('lookup test', function(assert) {
    let service = this.owner.lookup('service:loader');
  ...
  test('queryRecord test', function(assert) {
    ...
    service.checkRequisite = function() {};
    ...
    service.cache = EmberObject.create();
  ...
  test('unloadAll test', function(assert) {
    let testType1 = "a",
        service = this.owner.factoryFor('service:loader').create({
          nameSpace: "ns",
          store: {
