...
class SVGHelper(object):
    def __init__(self, w, h, parent=None):
        ...
        self.write(
            """<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" height="%d" width="%d">"""
            % (h, w)
        )
        self.write("""
    ...
    def rect(self, left, top, right, bottom, style="", title="", link=None):
        ...
        self.write(
            """<rect x="%d" y="%d" width="%d" height="%d" style="%s"><title>%s</title></rect>"""
