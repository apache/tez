...
public class ControllerUtils {
  ...
  public static List<File> getFiles(HttpServletRequest request, String parameterName) throws IOException {
    List<MultipartFile> uploadedFiles = ((StandardMultipartHttpServletRequest) request).getFiles(parameterName);
