...
public class ShuffleInputEventHandlerImpl implements ShuffleEventHandler {
  ...
  private void moveDataToFetchedInput(DataProto dataProto, FetchedInput fetchedInput,
      String hostIdentifier) throws IOException {
    switch (fetchedInput.getType()) {
      case DISK:
        ShuffleUtils.shuffleToDisk(((DiskFetchedInput) fetchedInput).getOutputStream(),
            ...
            dataProto.getUncompressedLength(), LOG, fetchedInput.getInputAttemptIdentifier(),
            ifileReadAhead, ifileReadAheadLength, true);
        break;
      case MEMORY:
