...
import org.apache.tez.mapreduce.task.impl.YarnTezChild;
...
public class MapReduceChildJVM2 {
  ...
  public static List<String> getVMCommand(
      ...
      ContainerId containerId, JobID jobID, boolean shouldProfile) {
    ...
    vargs.add(YarnTezChild.class.getName());  // main of Child
