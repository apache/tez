...
import org.apache.hadoop.mapreduce.v2.app2.rm.AMSchedulerEventNodeBlacklisted;
import org.apache.hadoop.mapreduce.v2.app2.rm.container.AMContainerEvent;
import org.apache.hadoop.mapreduce.v2.app2.rm.container.AMContainerEventNodeFailed;
...
public class AMNodeImpl implements AMNode {
  ...
  public void handle(AMNodeEvent event) {
    LOG.info("DEBUG: Processing NodeEvent " + event.getNodeId() + " of type "
  ...
  protected static class ContainerAllocatedTransition implements
    ...
    public void transition(AMNodeImpl node, AMNodeEvent nEvent) {
      AMNodeEventContainerAllocated event =
          (AMNodeEventContainerAllocated) nEvent;
