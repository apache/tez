...
//    sendEvent(new TaskCleanupEvent(this.attemptId, this.committer, taContext));
  ...
  MultipleArcTransition<TaskAttemptImpl, TaskAttemptEvent, TaskAttemptStateInternal> {
    ...
    public TaskAttemptStateInternal transition(TaskAttemptImpl attempt,
      ...
      if (readErrorEvent.getVersion() != attempt.getTaskAttemptID().getId()) {
        throw new TezUncheckedException(attempt.getTaskAttemptID()
      ...
      LOG.info(attempt.getTaskAttemptID()
      ...
      String message = attempt.getTaskAttemptID() + " being failed for too many output errors. "
