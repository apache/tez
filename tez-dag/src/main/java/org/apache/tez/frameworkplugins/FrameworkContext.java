...
public final class FrameworkContext {
  ...
  public FrameworkContext(Configuration conf) {
    ServerFrameworkService frameworkServiceFromConfig = FrameworkUtils.get(ServerFrameworkService.class, conf);
    frameworkService =
        frameworkServiceFromConfig == null ? new YarnServerFrameworkService() : frameworkServiceFromConfig;
    amExtensions = frameworkService.createAmExtensions();
  }
