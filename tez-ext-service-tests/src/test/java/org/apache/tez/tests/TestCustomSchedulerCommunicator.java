...
public class TestCustomSchedulerCommunicator {

  private static final Logger LOG = LoggerFactory.getLogger(TestCustomSchedulerCommunicator.class);


  private static final String EXT_PUSH_ENTITY_NAME = "ExtServiceTestPush";

  private static String TEST_ROOT_DIR =
      "target" + Path.SEPARATOR + TestCustomSchedulerCommunicator.class.getName()
          + "-tmpDir";
  ...
  public static void setup() throws Exception {
    ...
    confForJobs.setBoolean(TezTestServiceTaskSchedulerService.TEST_PASS_CONTAINERID_WITH_ALLOCATION, true);
  }
